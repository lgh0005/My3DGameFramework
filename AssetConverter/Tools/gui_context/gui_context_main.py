...
class GuiContextConvertMain(GUIContextBase):
    ...
    def _build_ui(self):
        ...
        button_texts = [
            ...
            "Convert texture to .ktx",
            "Convert 6 textures to .ktx CubeMap"]
        ...
        for text, command in zip(button_texts, [self._clicked_convert_animation,
                                                ...
                                                self._clicked_convert_ktx,
                                                self._clicked_convert_cube]):
    ...
    def _clicked_convert_ktx(self):
        self._window.set_context_by_name("ktx")

    def _clicked_convert_cube(self):
        self._window.set_context_by_name("cube")