...
UniversalGlobalUniforms::UniversalGlobalUniforms() = default;
UniversalGlobalUniforms::~UniversalGlobalUniforms() = default;
...
void UniversalGlobalUniforms::PreRender(RenderContext* context)
{
	if (!context) return;
...
//==============================*/
void UniversalGlobalUniforms::UpdateCameraUBO(Camera* camera)
{
...
void UniversalGlobalUniforms::UpdateLightUBO
(
