...
#pragma region GAME_OBJECT_SECTION
/*==============================//
//   scene life-cycle methods   //
//==============================*/
public:
	// TODO : Awake, Start, FixedUpdate, Update, LateUpdate
	void Start();
	void Update();

/*=======================================//
//   scene game object utility methods   //
//=======================================*/
public:
	// TODO : 추가해야 할 메서드
...
/*============================================//
//   runtime game object management methods   //
//============================================*/
protected:
...
#pragma region SCENE_PROPERTY_SECTION
/*=======================================//
