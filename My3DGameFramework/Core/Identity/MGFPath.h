...
namespace MGF3D
{
	...
	// 경로 정보 추출
	public:
		MGFPath GetDirectory() const { return m_path.parent_path(); }
	...
	// 경로 결합 (operator / 사용)
	public:
		MGFPath operator/(const MGFPath& other) const { return m_path / other.m_path; }
		MGFPath& operator/=(const MGFPath& other) { m_path /= other.m_path; UpdateRawPath(); return *this; }
