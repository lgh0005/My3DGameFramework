...
bool StandardDeferredLightingPass::Init()
{
	...
	(
		"standard_deferred_lighting",
		"@BuiltInAsset/Shaders/Standard/Standard_Deferred_LightPass.vert",
		"@BuiltInAsset/Shaders/Standard/Standard_Deferred_LightPass.frag"
	);
