...
{
	m_skyboxProgram = RESOURCE.Add<GraphicsProgram>
	(
		"common_skybox",
		"@BuiltInAsset/Shaders/Common/Common_Sky_Skybox.vert",
		"@BuiltInAsset/Shaders/Common/Common_Sky_Skybox.frag"
	);
	m_cubeMesh = RESOURCE.Get<StaticMesh>("Cube");
	return true;
};
