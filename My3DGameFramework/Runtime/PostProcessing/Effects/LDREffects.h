...
namespace MGF3D
{
	...
	public:
		...
		EToneMappingMode m_toneMappingMode{ EToneMappingMode::Exposure };
		float m_exposure{ 1.0f };
		float m_gamma{ 2.2f };

		// Camera dirt effect params
		GLTexture2DPtr m_cameraDirtTexture;
		...
		float m_flickerIntensity{ 0.002f };
	};
}
...
//};
//
//CLASS_PTR(LDREffects)
//class LDREffects : public PostProcessEffect
//{
//	using Super = PostProcessEffect;
//
//public:
//	virtual ~LDREffects() override;
//
//	static LDREffectsUPtr Create
//	(
//		int32 priority,
