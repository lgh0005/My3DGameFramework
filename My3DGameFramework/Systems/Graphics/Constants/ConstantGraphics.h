...
namespace MGF3D
{
	...
	static constexpr int32 SHADOW_RES_LOW{ 512 };
	static constexpr int32 SHADOW_RES_MEDIUM{ 1024 };
	static constexpr int32 SHADOW_RES_HIGH{ 2048 };
	static constexpr int32 SHADOW_RES_VERY_HIGH{ 4096 };

	// Shadow Layers & Counts
